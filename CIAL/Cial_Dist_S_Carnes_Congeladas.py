...
nameFile = 'Dist S Carnes Congeladas'
...
def UploadFileSftp(rutaOrigen, rutaDestino):
    ...
    rutasftp = f"/Semanales/Dist S carnes congeladas/{rutaDestino}"
    try:
...
try:
    ...
    query = "SELECT * FROM [CLIENTES_CIAL].[dbo].[TBL_Dist_S_Carnes_Congeladas] WITH(NOLOCK)"
