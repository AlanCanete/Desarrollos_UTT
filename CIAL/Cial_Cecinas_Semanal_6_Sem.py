...
nameFile = 'Cecinas Semanal 6 Sem'
...
def UploadFileSftp(rutaOrigen, rutaDestino):
    ...
    rutasftp = f"/Semanales/Cecinas Semanal/{rutaDestino}"
    try:
...
try:
    ...
    query = "SELECT * FROM [FIAMBRES_KEYACCOUNT_SEMANAL_CIAL_6_SEMANAS] WITH (NOLOCK)"
